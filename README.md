# dive
[![Go Report Card](https://goreportcard.com/badge/github.com/nextlinux/dive)](https://goreportcard.com/report/github.com/nextlinux/dive)
[![Pipeline Status](https://circleci.com/gh/nextlinux/dive.svg?style=svg)](https://circleci.com/gh/nextlinux/dive)
[![Donate](https://img.shields.io/badge/Donate-PayPal-green.svg?style=flat)](https://www.paypal.me/nextlinux)
...
docker run --rm -it \
      ...
      nextlinux/dive:latest build -t <some-tag> .
```
...
**Ubuntu/Debian**
```bash
wget https://github.com/nextlinux/dive/releases/download/v0.9.2/dive_0.9.2_linux_amd64.deb
sudo apt install ./dive_0.9.2_linux_amd64.deb
```

**RHEL/Centos**
```bash
curl -OL https://github.com/nextlinux/dive/releases/download/v0.9.2/dive_0.9.2_linux_amd64.rpm
...
Or download the latest Darwin build from the [releases page](https://github.com/nextlinux/dive/releases/download/v0.9.2/dive_0.9.2_darwin_amd64.tar.gz).

**Windows**

Download the [latest release](https://github.com/nextlinux/dive/releases/download/v0.9.2/dive_0.9.2_windows_amd64.zip).

**Go tools**
Requires Go version 1.10 or higher.

```bash
go get github.com/nextlinux/dive
```
*Note*: installing in this way you will not see a proper version when running `dive -v`.

**Docker**
```bash
docker pull nextlinux/dive
```

or

```bash
docker pull quay.io/nextlinux/dive
```
...
docker run --rm -it \
    -v /var/run/docker.sock:/var/run/docker.sock \
    nextlinux/dive:latest <dive arguments...>
```
